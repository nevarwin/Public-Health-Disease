...
<form method="POST">
    ...
    <div class="row mb-3">
        <label class="col-sm-3 form-label font-weight-bold">Type</label>
        <div class="col-sm-6">
            <p> <?php echo $type; ?> </p>
        </div>
    </div>
    <div class="row mb-3">
        <label class="col-sm-3 form-label font-weight-bold">Lab Test</label>
        <div class="col-sm-6">
    ...
    <div class="row mb-3">
        <label class="col-sm-3 form-label font-weight-bold">Clinical Class</label>
        <div class="col-sm-6">
