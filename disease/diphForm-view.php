...
<div class="row mb-3">
    <label for="dptDoses" class="col-sm-4 form-label font-weight-bold">Dpt Doses</label>
    <div class="col-sm-6">
        <p> <?php echo $dptDoses; ?> </p>
    </div>
</div>
<div class="row mb-3">
    <label for="" class="col-sm-4 form-label font-weight-bold">Date Last Dose</label>
    <div class="col-sm-6">
        <p> <?php echo $dateLastDose; ?> </p>
    </div>
</div>
<div class="row mb-3">
    <label for="caseClass" class="col-sm-4 form-label font-weight-bold">Case Classification</label>
    <div class="col-sm-6">
