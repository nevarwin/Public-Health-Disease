...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    do {
        ...
        if ($result) {
            $message = "Cholera info successfully added!";
            $type = 'success';
            $strongContent = 'Holy guacamole!';
            $alert = generateAlert($type, $strongContent, $message);

            echo "<script>
                alert('Cholera form submitted successfully!');
...
<div class="row d-flex justify-content-center">
    <div class="card shadow col-md-12 col-sm-4 col-lg-6" style="padding: 30px">
        <h2 class="row justify-content-center mb-3">Cholera Disease Form</h2>
        <form method="POST">
            <?php
            if (!empty($alert)) {
                echo $alert;
            ...
            <div class="row justify-content-center mb-3">
                ...
                <div class="col-sm-6">
                    <input placeholder="ex. Not Done" type="text" class="form-control" id="stoolCulture" name="stoolCulture">
                </div>
            </div>
            <div class="row justify-content-center mb-3">
