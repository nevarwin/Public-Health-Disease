...
// read row 
$sql = "SELECT * FROM meningitisinfotbl WHERE patientId = $patientId";
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    do {
        // Insert the data into the meningitisinfotbl table
        $query = "UPDATE meningitisinfotbl
                SET
                    type = '$type',
                    labResult = '$labResult',
                    organism = '$organism',
...
<div class="row d-flex justify-content-center">
    <div class="card shadow col-md-12 col-sm-4 col-lg-6" style="padding: 30px">
        <h2 class="row justify-content-center mb-3">Meningitis Disease Form</h2>
        <form method="POST">
            <?php
            if (!empty($alert)) {
                echo $alert;
