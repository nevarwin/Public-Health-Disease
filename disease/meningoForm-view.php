...
<form method="POST">
    ...
    <div class="row mb-3">
        <label class="col-sm-3 form-label font-weight-bold">Seizure</label>
        <div class="col-sm-6">
            <p> <?php echo $seizure; ?> </p>
        </div>
    </div>
    <div class="row mb-3">
        <label class="col-sm-3 form-label font-weight-bold">Malaise</label>
        <div class="col-sm-6">
    ...
    <div class="row mb-3">
        <label class="col-sm-3 form-label font-weight-bold">Rash</label>
        <div class="col-sm-6">
            <p> <?php echo $rash; ?> </p>
        </div>
    </div>
    ...
    <div class="row mb-3">
        <label class="col-sm-3 form-label font-weight-bold">Petechia</label>
        <div class="col-sm-6">
            <p> <?php echo $petechia; ?> </p>
        </div>
    </div>
    <div class="row mb-3">
        <label class="col-sm-3 form-label font-weight-bold">SensoriumCh</label>
        <div class="col-sm-6">
    ...
    <div class="row mb-3">
        <label class="col-sm-3 form-label font-weight-bold">Purpura</label>
        <div class="col-sm-6">
            <p> <?php echo $purpura; ?> </p>
        </div>
    </div>
    <div class="row mb-3">
        <label class="col-sm-3 form-label font-weight-bold">Drowsiness</label>
        <div class="col-sm-6">
            <p> <?php echo $drowsiness; ?> </p>
        </div>
    </div>
    <div class="row mb-3">
        <label class="col-sm-3 form-label font-weight-bold">Dyspnea</label>
        <div class="col-sm-6">
    ...
    <div class="row mb-3">
        <label class="col-sm-3 form-label font-weight-bold">Clinical Pres</label>
        <div class="col-sm-6">
    ...
    <div class="row mb-3">
        <label class="col-sm-3 form-label font-weight-bold">Antibiotics</label>
        <div class="col-sm-6">
            <p> <?php echo $antibiotics; ?> </p>
        </div>
    </div>
    <div class="row mb-3">
        <label class="col-sm-3 form-label font-weight-bold">Blood Specimen</label>
        <div class="col-sm-6">
