...
<div class="row mb-3">
    <label class="col-sm-4 form-label font-weight-bold">Measles Vaccine</label>
    <div class="col-sm-6">
        <p> <?php echo $measVacc; ?> </p>
    </div>
</div>
<div class="row mb-3">
    <label class="col-sm-4 form-label font-weight-bold">VitaminA</label>
    <div class="col-sm-6">
...
<div class="row mb-3">
    <label class="col-sm-4 form-label font-weight-bold">Koplik Spot</label>
    <div class="col-sm-6">
        <p> <?php echo $koplikSpot; ?> </p>
    </div>
</div>
<div class="row mb-3">
    <label for="" class="col-sm-4 form-label font-weight-bold">Last Vaccine</label>
    <div class="col-sm-6">
        <p> <?php echo $lastVac; ?>
    </div>
</div>
...
<div class="row mb-3">
    <label class="col-sm-4 form-label font-weight-bold">Red Eye</label>
    <div class="col-sm-6">
        <p> <?php echo $redEyes; ?> </p>
    </div>
</div>
<div class="row mb-3">
    <label class="col-sm-4 form-label font-weight-bold">Arthritis Arthralgia</label>
    <div class="col-sm-6">
        <p> <?php echo $arthritisArthralgia; ?> </p>
    </div>
</div>
<div class="row mb-3">
    <label class="col-sm-4 form-label font-weight-bold">SwolympNod</label>
    <div class="col-sm-6">
        <p> <?php echo $swolympNod; ?> </p>
    </div>
</div>
<div class="row mb-3">
    <label class="col-sm-4 form-label font-weight-bold">Complications</label>
    <div class="col-sm-6">
...
<div class="row mb-3">
    <label class="col-sm-4 form-label font-weight-bold">Final Class</label>
    <div class="col-sm-6">
        <p> <?php echo $finalClass; ?> </p>
    </div>
</div>
<div class="row mb-3">
    <label class="col-sm-4 form-label font-weight-bold">Infection Source</label>
    <div class="col-sm-6">
