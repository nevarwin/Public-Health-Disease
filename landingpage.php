...
<body>
  ...
  <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
    ...
    <<div class="carousel-inner">
      <div class="carousel-item active">
        <img src="landingpage/img/phhome1.jpg" class="d-block w-100" alt="Public Health Disease Geomapping" />
      ...
      <div class="carousel-item">
        <img src="landingpage/img/phhome3.jpg" class="d-block w-100" alt="Public Health Disease Geomapping" />
        <div class="carousel-caption">
      ...
      <div class="carousel-item">
        <img src="landingpage/img/phhome2.jpg" class="d-block w-100" alt="Public Health Disease Geomapping" />
        <div class="carousel-caption">
  ...
  <section id="geomapping" class="about pt-5">
    <div class="container">
      <div class="row">
        <div class="col-md-12">
      ...
      <div class="row">
        <div class="col-lg-6 col-md-12 col-12">
          <div class="about-img">
            <img src="landingpage/img/geomapping.svg" alt="" class="img-fluid" />
          </div>
        </div>
  ...
  <div id="scroll-target">
    <section class="services py-4" id="services" style="background-color: rgba(156,204,101,0.5);">
      <div class=" container">
        <div class="row">
          <div class="col-md-12">
            <div class="section-header text-center">
              ...
              <?php
              include('landingpage/js/landingDropdown.php')
              ?>
            </div>
          </div>
        </div>
          ...
          <div class="col-md-12 col-lg-12">
            <div class="row">
              <div class="col col-sm-12 col-md-12 col-lg-8 section-padding pt-2" style="height: 600px;">
                <?php include('landingpage/landingPageHeatmap.php') ?>
              </div>
  ...
  <!-- All Js -->
  <script src="landingpage/js/landingPageChart.js"></script>
